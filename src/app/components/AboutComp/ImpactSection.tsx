...
const ImpactSection = () => {
  return (
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center gap-3 ">
      <div className="2xl:w-170 xl:w-130 lg:w-120 md:w-110 w-full rounded-xl overflow-hidden shadow-md mx-[10px] h-[280px]">
        <Image
          src={images.Impact}
          alt="Happy learner"
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-3 2xl:w-150 xl:w-110 lg:w-100 md:w-90 w-full h-[280px]">
