...
//       <section className="flex flex-col self-center mt-20 w-full max-w-[1326px] max-md:mt-10 max-md:max-w-full pl-1 p-1">
//         <div className="flex flex-col items-start mr-0 w-full max-md:max-w-full">
...
//       <section className="flex flex-col self-center mt-20 w-full max-w-[1326px] max-md:mt-10 max-md:max-w-full">
//         <h2 className="self-start text-3xl font-bold text-center text-neutral-900 max-md:max-w-full">
...
//                       key={index}
//                       duration="40 min"
//                       title="Holding Yourself & Others Accountable"
//                       lessons={12}
//                       rating={4.5}
//                       price="$149.00"
//                     />
