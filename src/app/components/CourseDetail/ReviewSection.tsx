  ...
  return (
    <section className="mt-12 max-md:mt-10 ml-auto">
      <div className="flex gap-2 items-center text-3xl font-bold text-neutral-900">
        ...
        />
        <h2 className="self-stretch my-auto max-md:max-w-full">
          4.6 course rating - 22K ratings
        </h2>
      </div>
          ...
          <article key={index} className="flex flex-col w-full max-md:mt-10">
            <div className="flex flex-col w-full">
              <div className="flex gap-4 items-center self-start">
                <img
                  src={index % 2 === 0 ? "https://cdn.builder.io/api/v1/image/assets/TEMP/e59055240468080ad8f90a1ba9f520e47a9834de?placeholderIfAbsent=true&apiKey=5551d33fb4bb4e9e906ff9c9a5d07fe5" : "https://cdn.builder.io/api/v1/image/assets/TEMP/4146b3ab3af94fb6d649217178bee4654f1b0132?placeholderIfAbsent=true&apiKey=5551d33fb4bb4e9e906ff9c9a5d07fe5"}
                  alt="User avatar"
              ...
              <p className="mt-6 text-base font-medium leading-6 text-neutral-900">
                ...
                {index % 2 !== 0 && (
                  <button className="text-sky-500 underline">Show more</button>
                )}
              </p>
            </div>

            <div className="flex gap-5 items-center self-start mt-6">
              <span className="self-stretch my-auto text-base text-gray-500">
                Helpful?
              </span>
